    ...
    >
      ...
      >
        ...
        <div className="flex justify-between items-start z-10">
          ...
          <span className="text-[8px] font-mono tracking-widest bg-purple-500/10 border border-purple-500/20 px-2 py-0.5 rounded text-purple-400 uppercase font-black">
            NEO SHARD
          </span>
        </div>

        <div className="z-10 flex flex-col mt-4">
          <span className="text-[7.5px] font-mono tracking-widest text-muted-foreground uppercase">
            INFRASTRUCTURE
          </span>
          <h4 className="text-xs font-black tracking-wide text-foreground uppercase mt-0.5">
            Team Member
          </h4>
        ...
        <div className="flex items-center gap-1.5 border-t border-border/20 pt-2 mt-1 z-10">
          ...
          <Sparkles className="w-3 h-3 text-purple-400 ml-auto opacity-70 animate-pulse motion-reduce:animate-none" />
        </div>
      </div>

      <span className="text-[8px] text-muted-foreground font-extrabold uppercase tracking-wide text-center">
        Hover card to trigger neon laser drawing paths
      </span>
    </div>
  );
};
