...
const PULSES = buildPulses(10);

export function HeroAnimatedGridGlow({
  eyebrow = "Build velocity, unlocked",
  title = "Engineering teams ship 4x faster with Lerpa UI.",
  description = "Open-source React primitives, motion-aware components, and a copy-paste registry built for teams who treat the interface as the product.",
  primaryCta = { label: "Start building", href: "#start" },
  secondaryCta = { label: "View on GitHub", href: "#github" },
  className,
  ...rest
}: HeroAnimatedGridGlowProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute left-1/2 top-[-10%] h-[60%] w-[70%] -translate-x-1/2 rounded-full bg-[radial-gradient(closest-side,oklch(0.7_0.18_280/0.32),transparent_70%)] blur-3xl" />
        <div className="absolute bottom-[-20%] right-[-10%] h-[55%] w-[55%] rounded-full bg-[radial-gradient(closest-side,oklch(0.78_0.16_200/0.28),transparent_70%)] blur-3xl" />
        ...
        <div className="text-center lg:text-left">
          ...
          >
            <a
              ...
              className="group inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/25 transition-all hover:shadow-xl hover:shadow-primary/30 hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background motion-reduce:transition-none"
            >
              {primaryCta.label}
              <ArrowRight
